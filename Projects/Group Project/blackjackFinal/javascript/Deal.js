...
function Deal() {
	...
	document.getElementById("dimg"+0).src = "images/"+dealerArray[0]+".jpg";
	document.getElementById("dimg"+0).style.visibility = "visible";
	document.getElementById("dimg"+1).src = "images/back.jpg";
	...
	document.getElementById("img"+i).src = "images/" + handArray[i]+ ".jpg";
