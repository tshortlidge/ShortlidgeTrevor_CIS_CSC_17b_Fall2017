    ...
    <body>
        ...
        echo "<table style ='width: 100%'>
            <h1><center>Leaderboard</center><h1>
               <tr>
               <th><center><a class='ex1' href='leaderboard_username_descend.php'>Username</a></center></th>
			   <th><center><a class='ex1' href='leaderboard_earning_descend.php'>Earning ($)</a></center></th>
               </tr>";
		...
		for ($i = count($sorted_username);  $i >= 0 ; $i--){
			for ($x = 0 ; $x < count($sorted_username) - 1; $x++){
				if($sorted_username[$x] > $sorted_username[$x+1]){
