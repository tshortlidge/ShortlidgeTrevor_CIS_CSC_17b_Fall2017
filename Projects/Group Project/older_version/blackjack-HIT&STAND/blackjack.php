...
<head>
  ...
  <script type="text/javascript" src="Card.js"></script>
	...
	<script type="text/javascript" src="hitMove.js"></script>
	<script type="text/javascript" src="standMove.js"></script>
...
<style>
  body, html {
    ...
    border-image: url(dealer.png) 50 round;
    width:220px;
    height:65px;
    top:50px;
    right:43%;
...
<div  class='Center' align='bottom'>
	...
	<!-- <button id="moveBtn" onclick = "split()" disabled="disabled">Split</button> -->
...
<script>
	...
	document.write('<div class = "balance"> <p><i class="fa fa-bitcoin" "style=color:gold"></i><b>Your balance have:<span id = "balance" style="color: orange">'+manage.getBalance()+'</span></b></p></div>');
